...
public class StudentRecord {
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((advisors == null) ? 0 : advisors.hashCode());
        result = prime * result + ((committee == null) ? 0 : committee.hashCode());
        result = prime * result + ((coursesTaken == null) ? 0 : coursesTaken.hashCode());
        result = prime * result + ((degreeSought == null) ? 0 : degreeSought.hashCode());
        result = prime * result + ((milestonesSet == null) ? 0 : milestonesSet.hashCode());
        result = prime * result + ((department == null) ? 0 : department.hashCode());
        result = prime * result + ((student == null) ? 0 : student.hashCode());
        result = prime * result + ((termBegan == null) ? 0 : termBegan.hashCode());
        return result;
    }
